    ...
    private boolean initializeExternalAdd(ContentValues values) {
        ...
        if (itemType != null &&
            ...
            if (cn != null) {
                ...
                /*Since we want to load the app widget immediately our app is loaded, we don't need to check for permissions.
                checking if the permission is accepted is not necessary and that is why we commented
                this line of code
                */
